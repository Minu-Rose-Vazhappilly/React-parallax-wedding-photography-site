...
import "../App.css"; // go one level up since Home.jsx is inside Pages
import { Swiper, SwiperSlide } from "swiper/react";
import "swiper/css";
import { Autoplay } from "swiper/modules";
import a1 from "../assets/a1.png";  // go up one level from Pages
import a2 from "../assets/a2.png";
import a3 from "../assets/a3.png";
import a4 from "../assets/a4.png";
import a5 from "../assets/a5.png";
import { Routes, Route, Link } from "react-router-dom";
import Portfolio from "./Portfolio"; // same folder (Pages), so "./"
        ...
        <div className="Hero-section" id="home">
                  ...
                  <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                      <ul className="navbar-nav">
                        ...
                        <li className="nav-item">
                          <a className="nav-link text-warning" style={{ fontWeight: "600", fontSize: "25px" }} href="#portfolio">Portfolio</a>
                        </li>
                        <li className="nav-item">
                ...
                <div className="container-fluid">
                  <div className="row">
                    <div className="col-md-6 col-12 p-3">
                      <img src="https://dbi-blog.s3.amazonaws.com/uploads/2017/06/DallasWilsonWeddingFilms-2-Love-Stories-TV-blog-post.jpg" alt="" style={{width:"450px",height:"300px"}}/>
                    </div>
                    <div className="col-md-6 col-12 p-3">
                      <p style={{textAlign:"justify"}}>
        
                        At Eternal Frames, we believe that every wedding is more than just an event—it’s a story of love, laughter, and timeless moments. Our journey began with a simple dream: to capture memories that couples can relive forever. Over the years, that dream has grown into a passion-driven studio trusted by countless families.
        
                        We specialize in blending candid storytelling with artistic photography, ensuring that each frame reflects genuine emotions. From the nervous smiles before “I do” to the joyful tears of loved ones, we aim to preserve every fleeting moment with authenticity and elegance.
        
                        Behind the lens, our dedicated team brings creativity, patience, and attention to detail. Whether it’s an intimate ceremony or a grand celebration, we work closely with our couples to understand their vision and translate it into beautiful, lasting memories.
        
                        For us, it’s not just about photographs—it’s about crafting an eternal legacy of love.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="f-photo" id="featured" style={{ backgroundColor: "white" }}>
                ...
                <Swiper className="swiper-slide" loop={true} spaceBetween={0} breakpoints={{
                  ...
                  autoplay={{
                    delay: 1000,          // time between slides
              ...
              <div className="mt-5">
                ...
                <div>
                  ...
                  <h3 className="text-center">A glimpse of the stories we’ve framed</h3>
                  ...
                  <SwiperSlide ><img src="https://thefennells.ie/source/wp-content/uploads/2019/02/Wedding-photographers-dublin-ireland-15.jpg" alt="" style={{width:"100vw",height:"400px"}} /></SwiperSlide>
                  <SwiperSlide><img src="https://michaelwillphotography.com/wp-content/uploads/2016/01/best-wedding-photos-pittsburgh-172-1.jpg" alt="" style={{width:"100vw",height:"400px"}} /></SwiperSlide>
                  <SwiperSlide><img src="https://images.pexels.com/photos/256737/pexels-photo-256737.jpeg?cs=srgb&dl=beautiful-blur-bridal-256737.jpg&fm=jpg" style={{width:"100vw",height:"400px"}} alt="" /></SwiperSlide>
                  <SwiperSlide><img src="https://staceyoliverphotography.co.uk/wp-content/uploads/2020/07/Dave-Lindsey-group-family-photo-e1595863485489-1030x605.png" alt="" style={{width:"100vw",height:"400px"}}/></SwiperSlide>
                  <SwiperSlide><img src="https://www.alfaazphotography.com/wp-content/uploads/2019/10/How-to-find-right-Indian-Wedding-Photographer-0028.jpg" alt="" style={{width:"100vw",height:"400px"}} /></SwiperSlide>
                  <SwiperSlide><img src="https://staceyoliverphotography.co.uk/wp-content/uploads/2022/07/pentre-mawr-4-1030x688.jpg" alt="" style={{width:"100vw",height:"400px"}} /></SwiperSlide>
                  <SwiperSlide><img src="https://www.arabiaweddings.com/sites/default/files/tips/2014/12/wedding_flowers.jpg" alt="" style={{width:"100vw",height:"400px"}} /></SwiperSlide>
                  <SwiperSlide><img src="https://withjoy.com/blog/wp-content/uploads/2023/12/average-cost-of-wedding-flowers.jpg" alt="" style={{width:"100vw",height:"400px"}} /></SwiperSlide>
                </Swiper>
                  <div className="mt-8">
                <div
                ...
                >
                  <button className="btn btn-primary"><Link to="/portfolio" className="text-light text-decoration-none">View Full Portfolio</Link></button> 
                </div>
              </div>
              ...
              <footer className="ft p-5" id="cont" style={{ height: "65vh" }}>
                <div >
                    <h1 className='text-center text-light'>Loved Our Work?</h1>
                    <p className='text-center text-light'>Contact:6282693587</p>
                </div>
                <div className="container-fluid">
                  <div className="row">
